...
#for i in range(6):
#    time = np.arange(0, len(ents[i]))
#    a_traj = np.array([max(ents[i])] * len(time))
#    plt.figure(figsize=(16, 9))
#    plt.plot(time, ents[i], linewidth=.1, color='b')
#    plt.plot(time, a_traj, linewidth=.5, color='r')
#    plt.savefig('ent_traj_{}A.png'.format(nums[i]))
#    plt.clf()
#    
#ent_ds
#nums
...
#        
#for i in range(6):
#    time = np.arange(0, len(ent_ds[i]))
#    plt.figure(figsize=(16, 9))
#    plt.scatter(time, ent_ds[i], color='b')
#    plt.savefig('ent_diff_{}A.png'.format(nums[i]), dpi=100)
#    plt.clf()
